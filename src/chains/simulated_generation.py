...
### Output Format ###
Respond in organized markdown text suitable for direct display to the patient. and then ask if they need more details or assistance, using at the beginning clear symbols like ❓ or ‼️ for questions and ✅ for confirmation.
